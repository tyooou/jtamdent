    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows={4}
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-lg"
      ...
      <button
        type="submit"
        className="bg-black text-white py-2 px-4 rounded-2xl hover:bg-gray-800 transition-colors font-medium text-base"
      >
        Send Message
      </button>
    </form>
